    ...
    <div>
        <div class="p-6 bg-white border-b border-gray-200 lg:p-8">
            ...
            <h4 class="mt-8 text-2xl font-medium text-gray-900">
                Welcome to <b>Products Management System.</b>
            </h4>

            <p class="mt-6 leading-relaxed text-gray-500">
                This Products Management System offers a solution for managing users and products, featuring an easy-to-use dashboard for administrators.
            </p>
            ...
            <div class="mt-5">
                ...
                <br>
                Product count: <span style="color: #6875F5;">{{ $page.props.counts.productCount }}</span>
            </div>
